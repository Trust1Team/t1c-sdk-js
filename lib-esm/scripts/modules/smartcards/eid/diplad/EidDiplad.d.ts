...
import { AddressResponse, AllCertsResponse, AuthenticateResponse, BiometricDataResponse, PictureResponse, SignResponse, TokenDataResponse } from './EidDipladModel';
...
export declare class EidDiplad implements AbstractEidDiplad {
